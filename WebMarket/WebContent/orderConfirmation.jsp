...
<body>
	...
	<div class="container col-8 alert alert-info">
		...
		<div>
			...
			<a href="./shippingInfo.jsp?cartId=<%=shipping_cartId%>" class="btn btn-seconary" role="button"> 이전 </a>
			<a href="./thankCustomer.jsp" class="btn btn-success" role="button"> 주문 완료 </a>
			<a href="./checkOutCancelled.jsp" class="btn btn-seconary" role="button"> 취소 </a>
		</div>
	</div>
</body>
</html>